...
/// A funnel — rules / filters (ORG-8).
pub const IC_RULES: &str = r#"<svg width="15" height="15" viewBox="0 0 16 16" fill="none"><path d="M2 3.5h12l-4.5 5v4l-3 1.5v-5.5L2 3.5Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/></svg>"#;
